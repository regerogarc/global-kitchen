...
urlpatterns = [
    ...
    path('CookBook/pagination/', views.pagination, name='pagination'),
    path('CookBook/<str:country>/pagination/', views.pagination, name="pagination"),
    path('CookBook/', views.cookbook, name='cookbook'),
    path('CookBook/<str:country>/', views.cookbook, name='cookbook'),
